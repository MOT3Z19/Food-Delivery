...
class HomeScreen extends StatelessWidget {
  ...
  MenuburgerController menuburgerController = Get.put(MenuburgerController());
  @override
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        itemCount: menuburgerController.menuList.length,
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (context, index){
                          var menu = menuburgerController.menuList[index];
                      return MostPopularCard(
                        image: Image.network(menu.image),
                        name: menu.name,
                      );
